...
import powerSGD_hook as powerSGD
import DPSGD_hook_ToBe as dpSGD
import accordion_hook as accordion
import accordion_lgreco_hook as accordion_lgreco
...
#             print("distributed powersgd", args.powersgd_rank)
...
#         if args.powersgd_rank:
#             print("distributed DPSGD", args.powersgd_rank)
#             state = dpSGD.PowerSGDState(torch.distributed.group.WORLD,
#                                         matrix_approximation_rank=args.powersgd_rank,
#                                         warm_start=True,
#                                         start_powerSGD_iter=args.warmup_step,
#                                         use_error_feedback=True,
#                                         min_compression_rate=2,
#                                         adjust_freq=args.warmup_step,
#                                         adjust_gamma=0.5)
#             para_model.register_comm_hook(state, dpSGD.powerSGD_hook)
#         if args.powersgd_rank:
#             print("distributed Accordion", args.powersgd_rank)
...
#             para_model.register_comm_hook(state, accordion.powerSGD_hook)
        if args.powersgd_rank:
            print("distributed Accordion + LGreCo", args.powersgd_rank)
            state = accordion_lgreco.PowerSGDState(torch.distributed.group.WORLD,
                                        matrix_approximation_rank=args.powersgd_rank,
                                        warm_start=True,
                                        start_powerSGD_iter=args.warmup_step,
                                        use_error_feedback=True,
                                        ...
                                        accordion_min=16,
                                        accordion_max=64)
            para_model.register_comm_hook(state, accordion_lgreco.powerSGD_hook)
